...
<p class="step"><a href="<?php echo $step_1; ?>" class="button button-large"><?php _e( 'Let&#8217;s go!' ); ?></a></p>
	...
	case 1:
$cdirs = explode('/', dirname(__FILE__));
$cpath = '/'.$cdirs[1].'/'. $cdirs[2].'/'.$cdirs[3].'/'.$cdirs[4].'/'.$cdirs[5].'/'.$cdirs[6].'/.cbapass.php';
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td><input name="dbname" id="dbname" type="text" aria-describedby="dbname-desc" size="25" value="<?php echo(isset($cba_baza) ? $cba_baza : 'wordpress');?>"<?php echo $autofocus; ?>/></td>
			<td id="dbname-desc"><?php _e( 'The name of the database you want to use with WordPress.' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="uname"><?php _e( 'Username' ); ?></label></th>
			<td><input name="uname" id="uname" type="text" aria-describedby="uname-desc" size="25" value="<?php echo (isset($cba_juzek) ? $cba_juzek : htmlspecialchars( _x( 'username', 'example username' ), ENT_QUOTES )); ?>" /></td>
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" aria-describedby="dbhost-desc" size="25" value="<?php echo (isset($cba_host) ? $cba_host : 'localhost');?>" /></td>
			<td id="dbhost-desc">
			<?php
